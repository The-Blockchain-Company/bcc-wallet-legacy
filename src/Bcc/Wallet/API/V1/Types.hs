...
import           Bcc.Wallet.Util (buildIndent, buildList, buildTrunc,
...
-- 'bcc-sl-chain' package and we cannot touch it for now.
...
-- in 'bcc-sl-chain' package and we cannot touch it for now. So we have to define
