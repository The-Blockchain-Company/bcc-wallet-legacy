...
import           Bcc.Wallet.Kernel.Prefiltering (PrefilteredBlock)
import qualified Bcc.Wallet.Kernel.Prefiltering as P
...
import           Bcc.Wallet.Kernel.Wallets (mkEosAddress)
