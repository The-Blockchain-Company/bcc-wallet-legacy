...
module Bcc.Wallet.Kernel.Invariants (
...
import qualified Bcc.Wallet.Kernel.DB.Read as DB
import           Bcc.Wallet.Kernel.DB.Spec.Pending (Pending)
import qualified Bcc.Wallet.Kernel.DB.Spec.Pending as Pending
import           Bcc.Wallet.Kernel.Internal (PassiveWallet,
                     walletSubmission)
import           Bcc.Wallet.Kernel.Read (DB, getWalletSnapshot)
import           Bcc.Wallet.Kernel.Submission (WalletSubmission)
import qualified Bcc.Wallet.Kernel.Submission as WS
