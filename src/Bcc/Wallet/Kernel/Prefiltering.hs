...
module Bcc.Wallet.Kernel.Prefiltering
    ( -- * Types
      PrefilteredBlock
    , PrefilteredTx
...
import           Bcc.Wallet.Kernel.DB.BlockContext (BlockContext, bcSlotId)
...
import           Bcc.Wallet.Kernel.DB.Resolved (ResolvedBlock, rbTxs,
