...
import           Bcc.Wallet.Kernel.DB.BlockContext (BlockContext)
...
import           Bcc.Wallet.Kernel.DB.TxMeta.Types (TxMeta (..))
import           Bcc.Wallet.Kernel.Util.Core (absCoin, sumCoinsUnsafe)
