module Bcc.Wallet.Kernel.DB.Updates (
    Updates(..)
  , noUpdates
  , addUpdate
  , removeNextUpdate
...
import           Bcc.Wallet.Kernel.Util.StrictList (StrictList)
...
-- "Bcc.Wallet.Kernel.NodeStateAdaptor" can be used to wait for these
-- notifications).
