  ...
  overlay = hackage:
    {
      packages = {
        ...
        bcc-wallet = ./.stack.nix/bcc-wallet.nix;
        acid-state-exts = ./.stack.nix/acid-state-exts.nix;
        bcc-sl-binary = ./.stack.nix/bcc-sl-binary.nix;
        bcc-sl-binary-test = ./.stack.nix/bcc-sl-binary-test.nix;
        bcc-sl-chain = ./.stack.nix/bcc-sl-chain.nix;
        bcc-sl-chain-test = ./.stack.nix/bcc-sl-chain-test.nix;
        bcc-sl-client = ./.stack.nix/bcc-sl-client.nix;
        bcc-sl-cluster = ./.stack.nix/bcc-sl-cluster.nix;
        bcc-sl-core = ./.stack.nix/bcc-sl-core.nix;
        bcc-sl-core-test = ./.stack.nix/bcc-sl-core-test.nix;
        bcc-sl-crypto = ./.stack.nix/bcc-sl-crypto.nix;
        bcc-sl-crypto-test = ./.stack.nix/bcc-sl-crypto-test.nix;
        bcc-sl-db = ./.stack.nix/bcc-sl-db.nix;
        bcc-sl-infra = ./.stack.nix/bcc-sl-infra.nix;
        bcc-sl = ./.stack.nix/bcc-sl.nix;
        bcc-sl-mnemonic = ./.stack.nix/bcc-sl-mnemonic.nix;
        bcc-sl-networking = ./.stack.nix/bcc-sl-networking.nix;
        bcc-sl-node = ./.stack.nix/bcc-sl-node.nix;
        bcc-sl-node-ipc = ./.stack.nix/bcc-sl-node-ipc.nix;
        bcc-sl-util = ./.stack.nix/bcc-sl-util.nix;
        bcc-sl-util-test = ./.stack.nix/bcc-sl-util-test.nix;
        bcc-sl-utxo = ./.stack.nix/bcc-sl-utxo.nix;
        bcc-sl-x509 = ./.stack.nix/bcc-sl-x509.nix;
        bcc-report-server = ./.stack.nix/bcc-report-server.nix;
        bcc-crypto = ./.stack.nix/bcc-crypto.nix;
        ip = ./.stack.nix/ip.nix;
