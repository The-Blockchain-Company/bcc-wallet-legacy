...
import qualified Bcc.Wallet.Kernel.CoinSelection.Generic.LargestFirst as Generic
import           Bcc.Wallet.Kernel.CoinSelection.Generic.Random
                     (PrivacyMode (..))
import qualified Bcc.Wallet.Kernel.CoinSelection.Generic.Random as Generic
