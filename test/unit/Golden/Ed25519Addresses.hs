...
import           Bcc.Mnemonic (Mnemonic, mkMnemonic)
import           Bcc.Wallet.Kernel.Ed25519Bip44 (ChangeChain (..),
...
data TestVector = forall n. KnownNat n => TestVector
    { _address
        :: Address -- | Corresponding Bcc Address
    , _accountIx
  ...
  where
    ...
    tests =
        [ TestVector
            ...
            , _mnemonicPassphrase = "Bcc the bcc that bcc!"
            }
